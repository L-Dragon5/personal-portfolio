...
export const skills: SkillGroup[] = [
  ...
  {
    label: "Data",
    items: ["PostgreSQL", "MySQL", "SQLite", "Redis", "S3"],
  },
  {
    label: "DevOps",
    items: [
  ...
  {
    label: "Testing",
    items: ["Vitest", "Playwright", "MSW", "Pest", "PHPUnit"],
  },
  {
    label: "Tooling",
